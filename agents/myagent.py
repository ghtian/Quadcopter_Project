...
class DDPG():
    ...
    def __init__(self, task):
        ...
        self.actor_target = Actor(self.state_size, self.action_size, self.action_low, self.action_high, self.aclr)

        # Critic (Value) Model
        self.critic_local = Critic(self.state_size, self.action_size, self.crlr)
        self.critic_target = Critic(self.state_size, self.action_size, self.crlr)
...
class OUNoise:
    ...
    def sample(self):
        ...
        x = self.state
        dx = self.theta * (self.mu - x) + self.sigma * np.random.randn(len(str(x)))
        self.state = x + dx
